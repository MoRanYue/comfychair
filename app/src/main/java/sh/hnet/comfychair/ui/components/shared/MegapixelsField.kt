...
/**
 * A single megapixels stepper field with constraints dynamically loaded
 ...
 * @param value Current megapixels value
...
fun MegapixelsField(
    ...
    val constraints = WorkflowConstraintsProvider.rememberConstraints("megapixels", workflowName)
